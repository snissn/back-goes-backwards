...
const out = path.join(root, 'standing-sequence-dense-grid');
...
const cards = steps.map(s => `<article class="card">
  <div class="figure"><img src="figures/figure-2-${s.number}.png" alt="Original Figure 2-${s.number}"></div>
...
const pdf = path.join(out, 'print/standing-sequence-dense-grid-letter.pdf');
