...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{deep wheel pose rotational torque woman yoga and sksleton muscle force diagram.jpeg}
  \caption{Conceptual illustration of deep Wheel pose with rotational torque and muscle force pathways.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{helical force model.jpeg}
  \caption{Helical force model emphasizing the spiral orientation and tensioning of the anterior hip capsule.}
  \label{fig:helical-force}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{rotate.png}
  \caption{Schematic of rotational-to-axial coupling in the helical hip model.}
  \label{fig:helical-rotate}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{hip force model full lower body.jpeg}
  \caption{Lower-body hip force model in a closed-chain configuration, illustrating load transfer through the extended hip.}
  \label{fig:hip-force-lower-body}
\end{figure}
