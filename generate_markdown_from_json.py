...
def generate_markdown_files_from_json(json_file="enriched_outline.json", combined_output_file="combined_output.md"):
    ...
    for i, chapter in enumerate(data["chapters"], start=1):
        ...
        print(f"Markdown file '{filename}' generated for chapter '{title}'.")
